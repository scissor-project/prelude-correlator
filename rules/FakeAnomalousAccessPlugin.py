...
class AnomalousAccessPlugin(Plugin):
    ...
    def check_transitions(self, idmef):
        ...
        self.is_person_entered_id(idmef):
            print("update PERSON_ENTERED timestamp")
    ...
    def watch_window(self, idmef):
        ...
        if correlator.checkCorrelation():
            print("CORRELATION ALERT {}".format(correlator.getCtx().get("alert.classification.text")))
    ...
    def run(self, idmef):
        ...
        if idmef is not None:
            ...
            self.is_invalid_event(idmef):
                print("EVENT {} FILTERED".format(self._getDataByMeaning(idmef, "event.text")))
                return
    ...
    def is_invalid_event(self, idmef):
        return (self._getDataByMeaning(idmef, "event.text") not in FILTERS) and not self.is_person_entered_id(idmef)
