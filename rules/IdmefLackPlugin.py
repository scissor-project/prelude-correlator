...
class IdmefLackPlugin(Plugin):
    ...
    def __init__(self, env):
        super(IdmefLackPlugin, self).__init__(env)
    ...
    def run(self, idmef):
        ...
        if correlator.isEmpty():
            ...
            options = { "expire": 30, "threshold": 5 ,"alert_on_expire": False, "window": 5, "reset_ctx_on_window_expiration": True, "check_burst": False, "check_on_window_expiration": True }
